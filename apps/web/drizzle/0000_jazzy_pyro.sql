CREATE TYPE "public"."user_role" AS ENUM('super_admin', 'qa_manager', 'supervisor', 'inspector', 'auditor');--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "roles" (
	"id" "user_role" PRIMARY KEY NOT NULL,
	"name" text NOT NULL,
	"description" text NOT NULL,
...
CREATE UNIQUE INDEX "users_employee_id_idx" ON "users" USING btree ("employee_id");--> statement-breakpoint
